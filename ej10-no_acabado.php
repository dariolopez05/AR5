...
<head>
    ...
    <title>Personas de pais concreto</title>
</head>
<body>
<form action="">
...
foreach ($data as $info) {
    echo $info["Favorites"] . "<br>";
    echo count($info["Favorites"]);
}
for ($i=0; $i < count($info["Favorites"]); $i++) { 
    if ($info["Favorites"][$i] == $comida) {
        array_push($paises, $info["Country"]);
        $total++;
    }
}
